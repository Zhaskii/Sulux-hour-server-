...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_media_folder" AS ENUM('brands', 'products', 'categories', 'general');
  CREATE TYPE "public"."enum_products_status" AS ENUM('draft', 'active', 'archived');
  CREATE TYPE "public"."enum_products_gender" AS ENUM('men', 'women', 'unisex');
  CREATE TYPE "public"."enum_products_movement" AS ENUM('automatic', 'quartz', 'mechanical', 'smart');
  ...
  CREATE TABLE "media" (
  	...
  	"folder" "enum_media_folder" DEFAULT 'general' NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"url" varchar,
  ...
  CREATE TABLE "products" (
  	...
  	"movement" "enum_products_movement",
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_products_movement";`)
}
